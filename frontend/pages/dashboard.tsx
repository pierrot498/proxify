...
// Mock data
const mockNodes = [
  { id: '1', lat: 40.7128, lng: -74.0060, type: 'client', bandwidth: 100, successRate: 98 },
  { id: '2', lat: 34.0522, lng: -118.2437, type: 'client', bandwidth: 75, successRate: 95 },
  { id: '3', lat: 51.5074, lng: -0.1278, type: 'validator', bandwidth: 200, successRate: 99 },
  { id: '4', lat: 48.8566, lng: 2.3522, type: 'client', bandwidth: 90, successRate: 97 },
  { id: '5', lat: 35.6762, lng: 139.6503, type: 'validator', bandwidth: 180, successRate: 98 },
];
